...
void startFreezeAction(IUseLayoutAction*, char const*, float, char const*);
void startFreezeActionEnd(IUseLayoutAction*, char const*, char const*);
const char* getActionName(al::IUseLayoutAction const*, char const*);
int getActionFrame(al::IUseLayoutAction const*, char const*);
